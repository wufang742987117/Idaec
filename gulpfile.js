...
var fileOPts = {
    ...
    styleCss: ['assets/css/style.css', 'assets/css/style_idaec.css','assets/css/quill.snow.css','assets/css/fileinput.min.css'],
    libJs: [
    ...
    appJs: // ["js/util.js",],
        [
            ...
            "help/tutorial_help.controller.js"
        ],
    view: [
        'account/*.html',
        'common/*.html',
